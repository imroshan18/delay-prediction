...
# ---------- Train Metadata (real numbers from your dataset) ----------
TRAIN_CONFIG = {
    "Nightjet": {
        "company": "NS Int",
        "numbers": [420, 402, 421, 403]
    },
    "Intercity": {
        "company": "NS",
        "numbers": [1410, 1409, 1414, 1413, 1714, 1716, 1718, 2217]
    },
    "Sprinter": {
        "company": "NS",
        "numbers": [5108, 4117, 4308, 5808, 5612, 4019, 6116, 4610]
    },
    "Stoptrein": {
        "company": "Arriva",
        "numbers": [37812, 32210, 37807, 37607, 20352, 8020, 20350, 30906]
    },
    "Intercity direct": {
        "company": "NS",
        "numbers": [1817, 1819, 1821, 1814, 1812, 2415, 1816, 1823]
    },
    "ICE": {
        "company": "DB",
        "numbers": [222, 121, 220, 225, 128, 123]
    },
    "EuroCity": {
        "company": "EuroCity",
        "numbers": [9211, 9215, 9212, 9219, 9216, 9223]
    },
    "Eurocity Direct": {
        "company": "NS",
        "numbers": [9512, 9523, 9516, 9520, 9527, 9524]
    },
    "Eurostar": {
        "company": "Eurostar",
        "numbers": [9301, 9310, 9106, 9303, 9115, 9316]
    },
    "European Sleeper": {
        "company": "European Sleeper",
        "numbers": [452, 453]
    },
    "Nachttrein": {
        "company": "NS Int",
        "numbers": [32748, 32786, 32749, 32787]
    }
}
...
# ---------- SESSION STATE: Reset Train Number when Train Name changes ----------
...
with col_inputs:
    ...
    # Train name (outside form, with callback)
    ...
    # Train number (dependent on train name)
    ...
    # Form for date/time, station, platform & submit
...
with col_outputs:
    ...
    if submitted:
        # Combine user-selected date and time
        arr_dt = datetime.combine(arrival_date, arrival_time)

        # Derive time features from user-selected datetime
        arr_hour = arr_dt.hour
        arr_dayofweek = arr_dt.weekday()  # 0 = Monday
        ...
        # Expected delay from class probabilities
        expected_delay = (
        ...
        st.caption(
            "Probabilities show how confident the model is in each delay range "
            "(e.g., 0.70 means a 70% chance of that delay category)."
        )
